...
const heroHeadlinesRoutes = require('./routes/heroHeadlines');
const adminHeroHeadlinesRoutes = require('./routes/adminHeroHeadlines');
...
app.use('/api/hero-headlines', heroHeadlinesRoutes);
...
app.use('/api/admin/hero-headlines', adminHeroHeadlinesRoutes);
