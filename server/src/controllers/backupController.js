...
const TABLE_SCHEMAS = {
  ...
  site_settings: ['id', 'site_name', 'tagline', 'logo_url', 'secondary_logo_url', 'brochure_url', 'meta_title', 'meta_description', 'contact_phone', 'contact_email', 'contact_address', 'whatsapp_number'],
