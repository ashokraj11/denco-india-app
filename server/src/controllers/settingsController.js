...
const COLUMNS = [
  'site_name', 'tagline', 'logo_url', 'secondary_logo_url', 'brochure_url', 'meta_title', 'meta_description',
  ...
  try {
    const [rows] = await pool.query(
      `SELECT site_name AS siteName, tagline, logo_url AS logoUrl, secondary_logo_url AS secondaryLogoUrl,
              brochure_url AS brochureUrl, meta_title AS metaTitle, meta_description AS metaDescription,
